...
Simple Syntax:`double/decimal ABS (double/decimal number)````sql
...
Simple Syntax:`double ATOF(string value)````sql
...
Simple Syntax:`long ATOL(string value)````sql
...
Simple Syntax:`long CEIL(double/decimal number)````sql
...
Simple Syntax:`long CEILING(double/decimal number)````sql
...
Simple Syntax:`double CONVERT_32NDS_TO_DOUBLE (string 32nds_string [, boolean throw_if_not_convertible])````sql
...
Simple Syntax:`string CONVERT_DOUBLE_TO_32NDS (double number [, boolean throw_if_not_convertible])````sql
...
Simple Syntax:`decimal DECIMAL(long/double number)````sql
...
Simple Syntax:`integer DECIMAL_COMPARE(decimal number1, decimal number2, decimal eps)````sql
...
Simple Syntax:`decimal DECIMAL_INFINITY()````sql
...
Simple Syntax:`decimal DECIMAL_NAN()````sql
...
Simple Syntax:`decimal DECIMAL_PI()````sql
...
Simple Syntax:`int DIV(integer number1, integer number2)````sql
...
Simple Syntax:`double DOUBLE_COMPARE(double number1, double number2, double eps)````sql
...
Simple Syntax:`double/decimal EXP(double/decimal number)````sql
...
Simple Syntax:`long FLOOR(double/decimal number)````sql
...
Simple Syntax:`double FRAND(double min, double max, integer seed)````sql
...
Simple Syntax:`int GCD(integer number1, integer number2)````sql
...
Simple Syntax:`double INFINITY()````sql
...
Simple Syntax:`double/decimal LOG(double/decimal number)````sql
...
Simple Syntax:`double/decimal LOG10(double/decimal number)````sql
...
Simple Syntax:`long MOD(long number1, long number2)````sql
...
Simple Syntax:`double/decimal POWER(double/decimal base, double/decimal exponent)````sql
...
Simple Syntax:`double RAND (long min, long max,integer seed)````sql
...
Simple Syntax:`double/decimal REPLACE_NAN(double/decimal number1, double/decimal number2)````sql
...
Simple Syntax:`long ROUND(double/decimal number)````sql
...
Simple Syntax:`decimal ROUND_DECIMAL(decimal number, integer precision [, string rounding_method])````sql
...
Simple Syntax:`double ROUND_DOUBLE(double number, integer precision [, string rounding_method])````sql
...
Simple Syntax:`int SIGN(double/decimal number)````sql
...
Simple Syntax:`double SQRT(double/decimal number)````sql
...
Simple Syntax:`double/decimal TRUNCATE(double/decimal number, int precision)````sql
