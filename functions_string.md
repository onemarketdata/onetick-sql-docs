...
Simple Syntax:`int ASCII(string value)````sql
...
Simple Syntax:`string BASE16_DECODE (string value)````sql
...
Simple Syntax:`string BASE16_ENCODE (string value)````sql
...
Simple Syntax:`string BASE64_DECODE (string value)````sql
...
Simple Syntax:`string BASE64_ENCODE (string value)````sql
...
Simple Syntax:`string CHAR(int ascii_code)````sql
...
Simple Syntax:`string CHAR_UTF8(int utf8_code)````sql
...
Simple Syntax:`int CHARACTER_LENGTH(string value)````sql
...
Simple Syntax:`int CHAR_LENGTH(string value)````sql
...
Simple Syntax:`int CHAR_LENGTH_UTF8(string value)````sql
...
Simple Syntax:`string CONCAT(string value1, string value2)````sql
...
Simple Syntax:`string DECIMAL_TO_STRING(decimal number, integer precision)````sql
...
Simple Syntax:`string INSERT(string value1, int start, int length, string value2)````sql
...
Simple Syntax:`string INSERT_UTF8(string value1, int start, int length, string value2)````sql
...
Simple Syntax:`int INSTR(string value,string substring)````sql
...
Simple Syntax:`int INSTR_UTF8(string value,string substring)````sql
...
Simple Syntax:`bool IS_CHARACTER_PRESENT(string field,string characters)````sql
...
Simple Syntax:`string LCASE(string value)````sql
...
Simple Syntax:`string LCASE_UTF8(string value)````sql
...
Simple Syntax:`string LEFT(string value, int count)````sql
...
Simple Syntax:`string LEFT_UTF8(string value, int count)````sql
...
Simple Syntax:`int LENGTH(string value)````sql
...
Simple Syntax:`int LOCATE(string value1, string value2[, int start])````sql
...
Simple Syntax:`int LOCATE_UTF8(string value1, string value2[, int start])````sql
...
Simple Syntax:`string LOWER(string value)````sql
...
Simple Syntax:`string LOWER_UTF8(string value)````sql
...
Simple Syntax:`string LTRIM(string value)````sql
...
Simple Syntax:`int OCTET_LENGTH(string value)````sql
...
Simple Syntax:`int POSITION(string value1, string value2)````sql
...
Simple Syntax:`int POSITION_UTF8(string value1, string value2)````sql
...
Simple Syntax:`string REGEX_EXTRACT(string text, string pattern, string rewrite[, Boolean caseless])````sql
...
Simple Syntax:`string REGEX_EXTRACT_UTF8(string text, string pattern, string rewrite[, Boolean caseless])````sql
...
Simple Syntax:`bool REGEX_MATCH(string text, string pattern [, Boolean caseless])````sql
...
Simple Syntax:`bool REGEX_MATCH_UTF8(string text, string pattern [, Boolean caseless])````sql
...
Simple Syntax:`string REGEX_REPLACE(string text, string pattern, string rewrite [, Boolean global], Boolean caseless])````sql
...
Simple Syntax:`string REGEX_REPLACE_UTF8(string text, string pattern, string rewrite [, Boolean global], Boolean caseless])````sql
...
Simple Syntax:`string REPEAT(string value, int count)````sql
...
| 0
                       ...
                       | 2024-01-03 00:00:40.413537416
                                                                                                     ...
                                                                                                     | ONETICKONETICKONETICKONETICKONETICK
...
Simple Syntax:`string REPLACE(string value1, string value2, string value3)````sql
...
Simple Syntax:`string RIGHT(string value, int count))````sql
...
Simple Syntax:`string RIGHT_UTF8(string value, int count))````sql
...
Simple Syntax:`string RTRIM(string value)````sql
...
Simple Syntax:`string SPACE(int count)````sql
...
Simple Syntax:`string STR(double number, integer length, integer double_precision)````sql
...
Simple Syntax:`int STRCMP(string value1, string value2)````sql
...
Simple Syntax:`int STRLEN(string value)````sql
...
Simple Syntax:`string STR_TO_UTF8(string encoding, string value)````sql
...
Simple Syntax:`decimal STRING_TO_DECIMAL(string)````sql
...
Simple Syntax:`string SUBSTR(string value,int start_index,int num_bytes)````sql
...
Simple Syntax:`string SUBSTR_UTF8(string value,int start_index,int num_bytes)````sql
...
Simple Syntax:`string SUBSTRING(string value,int start_index,int num_bytes)````sql
...
Simple Syntax:`string SUBSTRING_UTF8(string value,int start_index,int num_bytes)````sql
...
Simple Syntax:`string TOKEN(string value,int token_index,char delimiter)````sql
...
Simple Syntax:`string TOSTRING (double number, integer base, integer double_precision)````sql
...
Simple Syntax:`string TRIM(string value)````sql
...
Simple Syntax:`string UCASE(string value))````sql
...
Simple Syntax:`string UCASE_UTF8(string value))````sql
...
Simple Syntax:`string UPPER(string value))````sql
...
Simple Syntax:`string UPPER_UTF8(string value))````sql
...
Simple Syntax:`string URLENCODE(string value)````sql
...
Simple Syntax:`string URLDECODE(string value)````sql
...
Simple Syntax:`string UTF8_TO_STR(string encoding, string value)````sql
