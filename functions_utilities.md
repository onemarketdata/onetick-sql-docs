...
Simple Syntax:`long COMPUTE_HASH_CODE(string str [, string hash_function])````sql
...
Simple Syntax:`string COMPUTE_HASH_CODE_STR(string str [, string hash_function])````sql
select PRICE, SIZE, EXCHANGE,
...
Simple Syntax:`string GETHOSTNAME()````sql
...
Simple Syntax:`string string GETUSER()````sql
...
Simple Syntax:`string string GET_AUTHENTICATED_USERNAME()````sql
...
Simple Syntax:`int GET_CPU_ID()````sql
...
Simple Syntax:`string GET_ONETICK_RELEASE()````sql
...
Simple Syntax:`long GET_ONETICK_VERSION()````sql
...
Simple Syntax:`int GET_SERVER_PORT()````sql
...
Simple Syntax:`int GET_THREAD_ID()````sql
...
Simple Syntax:`string GET_THREAD_NAME()````sql
...
Simple Syntax:`string GET_TOP_LEVEL_QUERY_ID()````sql
...
| 0
                       ...
                       | 2024-01-03 00:00:40.413537416
                                                                                                     ...
                                                                                                     | ip-10-36-13-227.96777.20250416093102.899.21221
...
Simple Syntax:`string GET_TOP_LEVEL_QUERY_NAME()````sql
...
Simple Syntax:`string GET_TYPE(field_name)````sql
...
Simple Syntax:`string GET_USER_ROLES()````sql
...
Simple Syntax:`string SELECT_MATCHING_FIELDS(string regex[, string field_types])````sql
...
Simple Syntax:`bool UNDEFINED(string name)````sql
select PRICE,
...
| 0
                       ...
                       | 2024-01-03 00:00:40.413537416
                                                                                                     ...
                                                                                                     | 12F0E7B3CE6B.1744796538466.344146.1
